...
// console.log(cars.indexOf("Mira",3))
...
// let cars = ["Civic","Mira","Prius","Vitz","Bolan"];
// let cars = ["h",54,6,76,7,4,43,2,43,423,54];
...
// let products = [["https://www.computerhope.com/cdn/keyboard/keyboard.jpg","Keyboard","Q135 | Adjustable Backlights. Press Fn+F8 will disable “Window” keys to avoid interruption during the game session.",4500, 3.4],
// ["https://globalcomputers.pk/wp-content/uploads/2022/12/asd.jpg","Mouse","The HARPOON RGB mouse is built to perform, featuring a 6000 DPI optical gaming",6700, 4.5],
// ["https://globalcomputers.pk/wp-content/uploads/2022/09/Samsung-350-Series-LS22F350-22-16-9-1920-x-1080-Resolution-FreeSync-LCD-Monitor-Price-in-Pakistan-01.jpg","LCD","Samsung LS22F350 22″ 16:9 1920 x 1080 Resolution FreeSync LCD Monitor Price in Pakistan Specs",3200, 4.7]]
...
// document.write(`<img src = "${products[0][0]}"> <h1>${products[0][1]}</h1> <p>${products[0][2]}</p> <p>RS: ${products[0][3]}</p> <p>Ratting: ${products[0][4]}</p>`)
// document.write(`<img src = "${products[1][0]}"> <h1>${products[1][1]}</h1> <p>${products[1][2]}</p> <p>RS: ${products[1][3]}</p> <p>Ratting: ${products[1][4]}</p>`)





// let numbers = [3,4,6,67,67,672,213,23,54,5,6756]


// for(i=0; i< numbers.length; i++){
//     document.write(`<h1>${numbers[i]}</h1>`)
// }
